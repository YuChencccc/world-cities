...
# note that you have to use 0.0 and 4.0 given that the data type of population is float
population_filter = st.slider('Minimal populations (Millions):', 0.0, 40.0, 3.6)  # min, max, default
